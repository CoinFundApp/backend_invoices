...
Once the relay server is up and running, please submit a Pull Request for the `/js/relays.js` file, found <a href="https://github.com/Spl0itable/coinfundit/blob/main/js/relays.js">here</a>.
